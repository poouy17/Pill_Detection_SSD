...
def draw_bounding_box_on_image(image,
  ...
  if thickness > 0:
    ...
    detect_box_location.append(left)
    detect_box_location.append(right)
    detect_box_location.append(top)
    detect_box_location.append(bottom)
  try:
...
#    print(left, (text_bottom - text_height - 2 * margin), (left + text_width),
#                                                          text_bottom)
#
#    draw.text(
...
def get_detect_box_location():
  return detect_box_location
...
def visualize_boxes_and_labels_on_image_array(
  ...
  return image, get_detect_box_location()
